#ifndef CANDANABUTODMPIPI_H
#define CANDANABUTODMPIPI_H
...
class candAnaBuToDmPiPi : public candAna {

public:
  candAnaBuToDmPiPi(recoilReader *pReader, std::string name, std::string cutsFile);
  virtual ~candAnaBuToDmPiPi();
