...
echo lcg-del -b -D srmv2 -l  "$PFNS/$STORAGE1/$ROOTFILE"
lcg-del -b -D srmv2 -l "$PFNS/$STORAGE1/$ROOTFILE"
...
# -- switch to xrdcp
xrdcp $ROOTFILE root://t3se01.psi.ch:1094/pnfs/psi.ch/cms/trivcat/$STORAGE1

echo "--> lcg-ls : $PFNS/$STORAGE1/$ROOTFILE"
echo lcg-ls -b -D srmv2 -l  "$PFNS/$STORAGE1/$ROOTFILE"
lcg-ls -b -D srmv2 -l  "$PFNS/$STORAGE1/$ROOTFILE"
