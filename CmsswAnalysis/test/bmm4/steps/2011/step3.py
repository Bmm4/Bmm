...
# with command line options: step2 --filein file:BdToMuMu_step2-40000.root --fileout file:BdToMuMu_step3-40000.root --mc --eventcontent AODSIM --datatier AODSIM --conditions START53_LV6::All --step RAW2DIGI,L1Reco,RECO,VALIDATION:validation_prod --python_filename step3.py --no_exec
import os
