...
# with command line options: Configuration/GenProduction/python/BPH-Summer11Leg-00014-fragment.py --fileout file:BPH-Summer11Leg-00014.root --mc --eventcontent RAWSIM --customise SimG4Core/Application/reproc2011_2012_cff.customiseG4,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions START53_LV4::All --beamspot Realistic7TeV2011CollisionV2 --step GEN,SIM --python_filename BPH-Summer11Leg-00014_1_cfg.py --no_exec -n 200000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Summer11: Pythia6+EvtGen generation of B+ --> J/psi K+, 7TeV, D6T tune'),
    name = cms.untracked.string('$Source: bla bla $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BuToJpsiKp_step1-40000.root'),
...
randHelper.populate() 
process.RandomNumberGeneratorService.saveFileName =  cms.untracked.string("RandomEngineState-40000.log")
