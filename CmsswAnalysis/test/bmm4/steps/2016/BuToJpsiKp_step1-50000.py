...
# with command line options: Configuration/GenProduction/python/BPH-RunIISummer15GS-00041-fragment.py --fileout file:BPH-RunIISummer15GS-00041.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --python_filename BPH-RunIISummer15GS-00041_1_cfg.py --no_exec -n 500000
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BuToJpsiKp_step1-50000.root'),
