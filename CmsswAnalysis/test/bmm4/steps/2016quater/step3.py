...
# with command line options: step2 --filein file:BPH-RunIISummer16DR80Premix-00009_step1.root --fileout file:BPH-RunIISummer16DR80Premix-00009.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step RAW2DIGI,RECO,EI --nThreads 1 --era Run2_2016 --no_exec
import os
