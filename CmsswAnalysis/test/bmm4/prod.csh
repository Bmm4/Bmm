...
# example submission: 
# -------------------
# run -t $BMMBASE/../150701.tar.gz -m batch -c ../../prod.csh -r 'PFNS srm://t3se01.psi.ch:8443/srm/managerv2\?SFN=/pnfs/psi.ch/cms/trivcat%STORAGE1 /store/user/ursl/bmm4/cmsRun/v00/Summer12_DR53X%SITE T3_CH_PSI' test.py
# ----------------------------------------------------------------------
