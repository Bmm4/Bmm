...
#         "/store/user/ursl/files/Summer12_DR53X/BuToJPsiK_K2MuPtEtaEtaFilter_8TeV-pythia6-evtgen-0000.root"
         "/store/user/ursl/files/Summer12_DR53X/BdToMuMu_BdFilter_8TeV-pythia6-evtgen-0000.root"
         , "/store/user/ursl/files/Summer12_DR53X/BdToMuMu_BdFilter_8TeV-pythia6-evtgen-0001.root"
         , "/store/user/ursl/files/Summer12_DR53X/BdToMuMu_BdFilter_8TeV-pythia6-evtgen-0002.root"
         , "/store/user/ursl/files/Summer12_DR53X/BdToMuMu_BdFilter_8TeV-pythia6-evtgen-0003.root"
 )
)
...
# ----------------------------------------------------------------------
rootFileName = "test-pythia6.root"
