...
#
# Note: this script does NOT use the (py) file with which it is submitted for sim/digi/reco,
#       it uses step2.py and step3.py which should be in the digireco.tar.gz file.
# ----------------------------------------------------------------------
setenv GENRELEASE CMSSW_5_3_16
setenv RECRELEASE CMSSW_5_3_16
...
echo "--> Running SGE run1 gen-digi-reco job wrapper"
echo $JOB
echo $FILE1
echo $FILE2
echo $FILE3
