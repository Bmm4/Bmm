...
process.hfrbupsik = cms.EDProducer(
    ...
    verbose    = cms.untracked.int32(0),
    candtype   = cms.untracked.int32(3000068),
)
...
process.hfrTest = cms.EDAnalyzer(
    "HfrTest",
    verbose            = cms.untracked.int32(0),
    filterLabel        = cms.untracked.InputTag("hfrbupsik"),
    trackPt            = cms.untracked.double(2.0),
    type               = cms.untracked.int32(2)
)

# ----------------------------------------------------------------------
process.hflistcand = cms.EDAnalyzer(
    "HFListCand",
    verbose            = cms.untracked.int32(0),
    filterLabel        = cms.untracked.InputTag("hfrbupsik"),
    trackPt            = cms.untracked.double(2.0),
...
# ----------------------------------------------------------------------
process.hfjpsixlist = cms.EDProducer(
...
# ----------------------------------------------------------------------
process.hfjpsixcand = cms.EDAnalyzer(
    "HFJpsiXCand",
    verbose            = cms.untracked.int32(0),
    filterLabel        = cms.untracked.InputTag("hfjpsixlist"),
