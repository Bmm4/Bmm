...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/Generator/python/recoil2_cff.py $')
)
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:recoil2_step1-40000.root'),
...
process.generator = cms.EDFilter(
        ...
        ExternalDecays = cms.PSet(
                ...
                EvtGen130 = cms.untracked.PSet(
                        ...
                        user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/recoil2.dec'
                        ),
...
process.ProductionFilterSequence = cms.Sequence(process.generator*process.bsfilter*process.jpsifilter)
