...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Bd2KPi_TuneZ2star_13TeV_cff.py,v $'),
    annotation = cms.untracked.string('Bd -> K+ pi- at 13TeV')
    )
