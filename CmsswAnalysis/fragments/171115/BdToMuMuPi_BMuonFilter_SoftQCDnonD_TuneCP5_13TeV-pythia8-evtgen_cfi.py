...
generator = cms.EDFilter(
    ...
    filterEfficiency = cms.untracked.double(2.880e-02),
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/EvtGenInterface/data/Bd_mumupi0.dec'),
...
decayfilter = cms.EDFilter(
    ...
    MinPt           = cms.untracked.vdouble(-99., 3.5, 3.5),
