...
# with command line options: Configuration/Generator/python/PYTHIA8_Bd2MuMu_EtaPtFilter_CUEP8M1_13TeV_cff.py --conditions auto:run2_mc -n 500000 --eventcontent FEVTDEBUG -s GEN,SIM --datatier GEN-SIM --beamspot NominalCollision2015 --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1 --fileout file:PYTHIA8_Bd2MuMu_EtaPtFilter_CUEP8M1_13TeV_step1-50000.root --no_exec --python_filename PYTHIA8_Bd2MuMu_EtaPtFilter_CUEP8M1_13TeV_step1-50000.py
...
process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
                                 generator = cms.PSet(initialSeed = cms.untracked.uint32(50000)),
                                 VtxSmeared = cms.PSet(initialSeed = cms.untracked.uint32(50000)),
                                 g4SimHits =  cms.PSet(initialSeed = cms.untracked.uint32(50000))
                                 )
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PYTHIA8_Bd2MuMu_EtaPtFilter_CUEP8M1_13TeV_step1-50000.root'),
