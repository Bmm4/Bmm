...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Bs2JpsiPhi_TuneZ2star_13TeV_cff.py,v $'),
    annotation = cms.untracked.string('Bs -> Jpsi Phi at 13TeV')
    )
