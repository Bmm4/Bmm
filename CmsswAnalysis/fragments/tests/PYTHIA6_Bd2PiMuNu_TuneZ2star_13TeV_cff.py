...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Bd2PiMuNu_TuneZ2star_13TeV_cff.py,v $'),
    annotation = cms.untracked.string('Bd -> pi- mu+ nu at 13TeV')
    )
