...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_BuJpsiK_TuneZ2star_13TeV_cff.py,v $'),
    annotation = cms.untracked.string('B+ -> Jpsi K+ at 13TeV')
    )
