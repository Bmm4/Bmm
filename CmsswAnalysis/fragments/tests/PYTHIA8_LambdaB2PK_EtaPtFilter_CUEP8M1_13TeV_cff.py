...
generator = cms.EDFilter("Pythia8GeneratorFilter",
                         ...
                         user_decay_file =  cms.vstring('GeneratorInterface/ExternalDecays/data/LambdaB_Kp.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Spring 2016: Pythia8+EvtGen130 generation of Lb --> P K-, 13TeV, Tune CUETP8M1')
    )
