...
# with command line options: Configuration/Generator/python/PYTHIA8_Bu2JpsiK_EtaPtFilter_CUEP8M1_13TeV_cff.py --conditions auto:run2_mc -n 500000 --eventcontent FEVTDEBUG -s GEN,SIM --datatier GEN-SIM --beamspot NominalCollision2015 --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1 --fileout file:PYTHIA8_Bu2JpsiK_EtaPtFilter_CUEP8M1_13TeV_step1-60000.root --no_exec --python_filename PYTHIA8_Bu2JpsiK_EtaPtFilter_CUEP8M1_13TeV_step1-60000.py
...
process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
                                 generator = cms.PSet(initialSeed = cms.untracked.uint32(60000)),
                                 VtxSmeared = cms.PSet(initialSeed = cms.untracked.uint32(60000)),
                                 g4SimHits =  cms.PSet(initialSeed = cms.untracked.uint32(60000))
                                 )
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PYTHIA8_Bu2JpsiK_EtaPtFilter_CUEP8M1_13TeV_step1-60000.root'),
...
process.kfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    ParticleID = cms.untracked.int32(521),
    MaxEta = cms.untracked.vdouble(99.0, 2.5),
    MinEta = cms.untracked.vdouble(-99.0, -2.5),
