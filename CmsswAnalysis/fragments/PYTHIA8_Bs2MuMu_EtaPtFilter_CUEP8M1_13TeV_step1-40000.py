...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PYTHIA8_Bs2MuMu_EtaPtFilter_CUEP8M1_13TeV_step1-40000.root'),
