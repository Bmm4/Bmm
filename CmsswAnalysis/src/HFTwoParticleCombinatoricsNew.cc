...
HFTwoParticleCombinatoricsNew::HFTwoParticleCombinatoricsSet
HFTwoParticleCombinatoricsNew::combine(std::vector<int> &tlist1, double mass1,
				       std::vector<int> &tlist2, double mass2,
